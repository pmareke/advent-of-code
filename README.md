...
Today was an easy day finally! The tricky part was that the **part one** could be solved using arrays but in the **part two** it produces and overdflow, and because of that I needed to change the approach.
